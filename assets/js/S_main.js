document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
      ...
      for (const service of services) {
        ...
        const iconSrc = iconExists
          ? service.icon
          : "../default-icon.svg"; // الأيقونة البديلة الافتراضية
        ...
        article.innerHTML = `
          <div class="card-inner relative w-full h-80">
            ...
            <div class="card-front absolute inset-0 bg-white rounded-2xl p-6 glass-effect flex flex-col justify-between">
              <div>
                <div class="w-16 h-16 rounded-xl bg-${service.color}-100 flex items-center justify-center mb-4 mx-auto">
              ...
              <div class="w-full flex items-center justify-between">
                <span class="text-${service.color}-600 font-bold">${service.price}</span>
            ...
            <!-- BACK -->
            <div class="card-back absolute inset-0 bg-gradient-to-br from-${service.color}-500 to-${service.color}-600 text-white rounded-2xl p-6 flex flex-col">
